...
| Protocol test coverage | Partial | Unit tests for command parsing, admin command builders, file transfer init/response parameters, URLs, byte buffer, icons, whisper, and notification import previews | Add more tests for package import/export edge cases. |
