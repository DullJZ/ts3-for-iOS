...
| Pokes | Partial | Receive poke notifications/events, online client-row poke, database-record and group-member online poke, poke-back, and online contact poke actions exist | Add broader real-server validation and any remaining context-menu entry points found in official-client audit. |
