...
| Privilege keys | Partial | Privilege key manager with create/use/delete, generated-key actions, readable exports/backups, backup import preview with copyable key summary, filter presets, and persistent recent results for offline review | Validate create/use/delete flows against real servers and audit any official-client edge fields. |
