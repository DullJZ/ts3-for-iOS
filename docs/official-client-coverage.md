...
| Complaints | Partial | Complaint management with target picker, direct create/delete, visible export, local archive import/export with restore preview, filter presets, complaint-source contact actions, and persistent recent results for offline review | Validate complaint add/remove flows against real servers and fill any remaining official-client context-menu edge cases. |
