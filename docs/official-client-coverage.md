...
| Permission backup/import | Partial | Permission backup export, guided restore preview with changed/unchanged/addition names, upsert restore, unchanged-entry skip, and conflict/addition counts | Add broader restore conflict handling and validate permission backup semantics against real servers. |
