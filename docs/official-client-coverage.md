...
| Server edit/settings | Partial | Server settings editor, quotas, host fields, icon support, complaint and anti-flood controls | Audit all official server edit tabs and fill missing fields. |
