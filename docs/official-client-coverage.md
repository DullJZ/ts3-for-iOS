...
| Offline messages | Partial | Inbox, compose, read/delete, local cached history, disconnected access, local archive import/export with restore preview, draft persistence, filters and presets | Validate server-side read/delete behavior against real servers. |
